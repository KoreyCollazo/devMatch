    ...
    <div className="col s12 m6">
      <div className="card">
        <div className="card-image">
          ...
          {status ? (<div className="btn-floating halfway-fab waves-effect waves-light green">
            <i className="material-icons"></i>
          </div>):(<div className="btn-floating halfway-fab waves-effect waves-light red">
            <i className="material-icons"></i>
          </div>)}
        </div>
        ...
        <div id="row">
          <div id="buttons">
            <button id="dislike" className="waves-effect waves-light btn red" tab-index="1" onClick={(()=>{setIndex(index + 1)})}>
            ...
            <button id="like" className="waves-effect waves-light btn green" tab-index="1" onClick={(()=>{setIndex(index + 1)})}>
